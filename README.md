...
Using SQL, I analysed cuisine distribution and geographic concentration.
...
•	Key columns: Restaurant Name, Cuisine Type, Michelin Rating, Price Range Text, Latitude, Longitude
The dataset is structured and suitable for SQL-based filtering and aggregation.

### 3.	Study Area Definition
Mayfair was defined using a latitude range between 51.510 and 51.516.
...
•	French restaurants within Mayfair range: 9 (30% of all French restaurants)
Within this area:
...
After identifying nearby competitors using SQL, I developed a simple comparison framework to analyse positioning differences.
The five dimensions used were:
•	Spatial Character
•	Chef-Centricity
•	Culinary Maturity
•	Experiential Design
...
The nearby Michelin French restaurants in Mayfair largely emphasise chef identity, culinary prestige, and premium positioning.
In contrast, our restaurant operates outside the Michelin-rated segment and positions itself as contemporary and socially driven.
Rather than competing on prestige and formal luxury, it focuses on atmosphere, accessibility, and a shareable dining experience.
